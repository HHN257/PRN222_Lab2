...
namespace QuitSmoking.Repository.NamHH.DBContext;

public partial class SU25_SE18_PRN222_SE1809_G6_QuitSmokingDBContext : DbContext
{
    public SU25_SE18_PRN222_SE1809_G6_QuitSmokingDBContext()
    {
    }

    public SU25_SE18_PRN222_SE1809_G6_QuitSmokingDBContext(DbContextOptions<SU25_SE18_PRN222_SE1809_G6_QuitSmokingDBContext> options)
        : base(options)
    {
    }
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=MAIN-PC\\SQLEXPRESS;Initial Catalog=SE18_PRN222_SE1809_G6_QuitSmokingDB;Persist Security Info=True;User ID=sa;Password=12345");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ConsultationSessionNamHh>(entity =>
        {
            entity.HasKey(e => e.ConsultationSessionNamHhid).HasName("PK__Consulta__14BE24B77F00FCE1");
            ...
            entity.HasOne(d => d.Coach).WithMany(p => p.ConsultationSessionNamHhCoaches)
                ...
                .HasConstraintName("FK__Consultat__Coach__6B24EA82");

            entity.HasOne(d => d.UserAccount).WithMany(p => p.ConsultationSessionNamHhUserAccounts)
                .HasForeignKey(d => d.UserAccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Consultat__UserA__6A30C649");
        });

        modelBuilder.Entity<HealthMetricTrungDn>(entity =>
        {
            entity.HasKey(e => e.HealthMetricTrungDnid).HasName("PK__HealthMe__71B39B71EEEB2FF5");
            ...
            entity.HasOne(d => d.SmokingRecordTrungDn).WithMany(p => p.HealthMetricTrungDns)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HealthMet__Smoki__656C112C");
        });

        modelBuilder.Entity<MembershipPackageQuanNh>(entity =>
        {
            entity.HasKey(e => e.MembershipPackageQuanNhid).HasName("PK__Membersh__87EF7594C4D0C06A");
        ...
        {
            entity.HasKey(e => e.NotificationThinhThpid).HasName("PK__Notifica__CE9B7E62AF85926E");
            ...
            entity.Property(e => e.Message)
                ...
                .IsUnicode(false);
            entity.Property(e => e.ModifiedDate).HasColumnType("datetime");
            entity.Property(e => e.NextTriggerTime).HasColumnType("datetime");
        ...
        {
            entity.HasKey(e => e.PlanStageVietHqid).HasName("PK__PlanStag__CE50C49779E862A0");
            ...
            entity.HasOne(d => d.QuitPlanVietHq).WithMany(p => p.PlanStageVietHqs)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PlanStage__QuitP__6754599E");
        });

        modelBuilder.Entity<QuitPlanVietHq>(entity =>
        {
            entity.HasKey(e => e.QuitPlanVietHqid).HasName("PK__QuitPlan__24BE10A0B6184A73");
            ...
            entity.HasOne(d => d.UserAccount).WithMany(p => p.QuitPlanVietHqs)
                .HasForeignKey(d => d.UserAccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__QuitPlanV__UserA__66603565");
        });

        modelBuilder.Entity<SessionFeedbackNamHh>(entity =>
        {
            entity.HasKey(e => e.SessionFeedbackNamHhid).HasName("PK__SessionF__1E90152F7802505A");
            ...
            entity.HasOne(d => d.ConsultationSessionNamHh).WithMany(p => p.SessionFeedbackNamHhs)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__SessionFe__Consu__6C190EBB");
        });

        modelBuilder.Entity<SmokingRecordTrungDn>(entity =>
        {
            entity.HasKey(e => e.SmokingRecordTrungDnid).HasName("PK__SmokingR__C17B24D69201CC5E");
            ...
            entity.HasOne(d => d.UserAccount).WithMany(p => p.SmokingRecordTrungDns)
                .HasForeignKey(d => d.UserAccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__SmokingRe__UserA__6477ECF3");
        });

        modelBuilder.Entity<SystemUserAccount>(entity =>
        {
            entity.HasKey(e => e.UserAccountId).HasName("PK__System_U__DA6C70BA91F891C5");
        ...
        {
            entity.HasKey(e => e.UserNotificationThinhThpid).HasName("PK__UserNoti__E93D3877278CF2D4");
            ...
            entity.HasOne(d => d.NotificationThinhThp).WithMany(p => p.UserNotificationThinhThps)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserNotif__Notif__693CA210");

            entity.HasOne(d => d.UserAccount).WithMany(p => p.UserNotificationThinhThps)
                .HasForeignKey(d => d.UserAccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserNotif__UserA__68487DD7");
        });

        modelBuilder.Entity<UserSubscriptionQuanNh>(entity =>
        {
            entity.HasKey(e => e.UserSubscriptionQuanNhid).HasName("PK__UserSubs__ACFC44D9F8FA80B8");
            ...
            entity.HasOne(d => d.MembershipPackageQuanNh).WithMany(p => p.UserSubscriptionQuanNhs)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserSubsc__Membe__6383C8BA");

            entity.HasOne(d => d.UserAccount).WithMany(p => p.UserSubscriptionQuanNhs)
                .HasForeignKey(d => d.UserAccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserSubsc__UserA__628FA481");
        });
